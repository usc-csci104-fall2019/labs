...
TEST(ValidBSTTest, IsBST) {
    ...
    EXPECT_TRUE(isBST(&n8));
}

TEST(ValidBSTTest, AnotherIsBST) {
    //leaf nodes
    //8 15 90
    Node n8(8);
    Node n15(15);
    ...
    EXPECT_TRUE(isBST(&n30));
}

TEST(ValidBSTTest, IsNotBST) {
    Node n4(4);
    Node n7(7);
    Node n1(1);
    Node n13(13);
    ...
    EXPECT_FALSE(isBST(&n8));
}

TEST(ValidBSTTest, AnotherIsNotBST) {
    //leaf nodes
    //90 30 12
    Node n90(90);
    Node n30(30);
...
TEST(ValidBSTTest, AnotherAnotherIsNotBST) {
    //leaf nodes
    //90 30 12
    Node n10(10);
    Node n125(125);
    ...
    Node n50(&n10, &n125, 50);
    Node n150(&n75, &n200, 150);

    Node n100(&n50, &n150, 100);

    EXPECT_FALSE(isBST(&n100));
}
